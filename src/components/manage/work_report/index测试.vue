...
<!-- 采购表单 -->
   <div class="task_content" v-for="(item,index) in taskList" :key="index"  @click="turnTo('/manage/work_report/report_del')">
     <div class="task_header">
      <span class="el-icon-tickets"></span>
      <span class="type">类型:日报</span>
      <span class="state" v-show="true">已阅</span>
     </div>
     <div class="task_main">
       <p>这是一个最新的日报</p>
          <span class="apply">汇报人:蒋委员长</span>
       <div class="time">
