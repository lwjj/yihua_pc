...
<div style="height:100vh">
    <yd-layout class="layout_my" v-if="!showReplay">
      ...
      <div class="organInfos" v-if="info">
        ...
        <div class="contacts">
           <ul>
              <li><img style="width:.7rem;height:.7rem;" src="../../../../../assets/images/estate/rent.png" alt=""></li>
              <li>
           ...
           <ul>
              <li><img style="width:.7rem;height:.7rem;" src="../../../../../assets/images/estate/yezhu.png" alt=""></li>
    ...
    <yd-timeline v-if="info" class="mt2">
        <yd-timeline-item  v-for='(item,index) in info.tasksRecordList' :key='index'>
          <!-- <img style="width:.4rem;height:.4rem" src="../../../../../assets/images/estate/chooseSelected.png" 
          slot="icon" v-if='index==0' alt=""> -->
          <yd-icon name='tongxinyuan' custom size='.38rem' slot='icon' :color='mainColor'></yd-icon>
          <div class="font32 mb2" :style="`color:${mainColor}`" style="background:#fff;">{{item.title}}</div>
    ...
    <div class="flex-row h9 bgwhite bt font32" v-if='(info && info.rectificationBill.status==2) && info.tasks' slot='bottom'>
      <div class="flex1 jusCenter br" @click="disagree1">\assets\images\estate
        <img style="width:.4rem;height:.4rem;" class="mr1" src="../../../../../assets/images/estate/disagree.png" alt="">
        <span style='color:#ff483f;'>不同意</span>
      </div>
      <div class="flex1 jusCenter" @click='agree1'>
        <img style="width:.4rem;height:.4rem;" class="mr1" src="../../../../../assets/images/estate/select_active.png" alt="">
...
import qs from "qs";
import replay from "../wuye/rectification/replay";
