<template>
  <yd-layout class="layout_my">
      ...
      <span @click="back" class="addClickArea" slot="left">
        ...
        <div slot="right" v-if="userInfo.organType == 3" @click="$router.push('/estate/serviceList/wuye/rectification/add')" class="edit addRightClickArea" style="color: #fff;font-size:.6rem;">+</div>
      </yd-navbar>
