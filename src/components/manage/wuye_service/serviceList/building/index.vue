  ...
  <div class="newRightContent"> 
    <div class="title">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item v-if="this.userInfo.organType ==3" :to="{path: '/manage/wuye_service'}">物业服务单</el-breadcrumb-item>
            <el-breadcrumb-item>特约写字楼</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox" style="padding-top:10px;">
      <div> 
        ...
        <el-button style="float:right;margin-right:10px;" @click="$router.push('/estate/serviceList/building/operate')">合作楼盘</el-button> 
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"
           >
           <template slot-scope="scope">
             <el-button size="small" @click="toDetail(scope.row)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <div id="printcode" v-show="print1" >
        <el-table
          :data="list"
          border
           :style="{height:list.length*106+48+'px'}"
          >
          <el-table-column
            label="大厦图标"
            width="280px"
