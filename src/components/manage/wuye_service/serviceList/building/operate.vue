  ...
  <div class="newRightContent"> 
    <div class="title">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item @click.native='$router.push("/estate/serviceList/building")'>特约写字楼</el-breadcrumb-item>
    ...
    <div class="tableBox">
      <!-- <div class="tableTop"> 
        ...
        <el-button @click="$router.push('/estate/serviceList/building/operate')">合作楼盘</el-button> 
      </div> -->
      <el-table
        :data="list"
        height="250"
