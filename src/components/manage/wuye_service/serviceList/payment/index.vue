     ...
     <!-- {{contentList}} -->
      <div class="tableBox">
        <div class="tableTop"> 
          <div>
            <span>状态：</span>
            <el-select @change='changeData1' v-model="value1" clearable placeholder="请选择">
              <el-option
          ...
          <div>
            <span>缴费单类型：</span>
            <el-select @change='changeData2' v-model="value2" clearable placeholder="请选择">
              <el-option
          ...
          <div>
            <!-- <el-button-group>
              <el-button type="primary" icon='el-icon-plus' @click="show2 = true">新建</el-button> 
                  <el-button class="ml2" type="primary" @click.native='$router.push("/estate/serviceList/payment/moneyset")'>银行卡设置</el-button>
            </el-button-group> -->
          </div>
        ...
        <el-table-column width="140" prop="organResult.organName"  
          show-overflow-tooltip	
         label="公司">

        </el-table-column>
        <el-table-column label="缴费类型" width='130' prop='name'> 
        </el-table-column>
        <el-table-column 
          prop="guid"
          label="租户单元"
        ...
        <el-table-column
          label="详情"
           > 
           <template slot-scope="scope">
             <el-button type="button" class="el-button el-button--default el-button--small is-plain" @click="turnTo('/estate/serviceList/wuye/payment/expense/'+scope.row.guid+'#'+scope.row.type)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
export default {
  data() {
    ...
    return {
      ...
      myItems2: [
        {
          ...
          callback: () => {
            console.log(1);
            this.$router.push("/estate/serviceList/newPayment/1");
          }
        },
        {
          label: "专项缴费单",
          callback: () => {
            ...
            this.$router.push("/estate/serviceList/newPayment/2");
          }
        }
      ],
      ...
      show: false,
      show1: false,
      options1: [{ value: 1, name: "物业费" }, { value: 2, name: "专项费" }],
      screen: {
