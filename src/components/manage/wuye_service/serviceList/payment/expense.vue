<template>
  <yd-layout class="layout_my">
      <yd-navbar class="header" v-title="titleT" slot="navbar" v-show="!userAgent.isWX" :title="titleT" color="#fff" :bgcolor="mainColor" height=".88rem">
         <span @click="back" class="spanLeft addClickArea" slot="left">
    ...
    <div class="organInfos">
      <div class="name">
        ...
        <span class="state1 state" v-if='propertyServicePay.state==3'>已完成</span>
      </div>
    ...
    <div class="buttons" v-if="propertyServicePay.state==0 || propertyServicePay.state==2">
