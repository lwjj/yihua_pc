  ...
  <div class="border bgwhite">
     <div class="title">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item @click.native="mBack">返回</el-breadcrumb-item>
            <el-breadcrumb-item>新增物品</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
...
export default {
  ...
  methods: {
    ...
    add() {
      console.log(this.bm);
      if (this.bm.amount > 0 && this.bm.itemName != "") {
        this.imgUrls.push(this.imgUrl);
        this.$emit("mBack", { bm: this.bm, imgUrl: this.imgUrl });
