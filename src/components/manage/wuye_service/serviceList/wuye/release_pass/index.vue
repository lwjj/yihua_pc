   ...
   <div class="layout_my newRightContent">
    <div class="title">
       <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>放行条</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox"  style="padding-top:10px;">
      <div> 
        ...
        <el-button-group v-if="showBuild" style="float:right;margin-right:10px;">
          ...
          '  @click="turnTo('/estate/serviceList/wuye/release_pass/declares#1')">新建访客放行条</el-button>
          <el-button icon='el-icon-plus
          '  @click="turnTo('/estate/serviceList/wuye/release_pass/declares#2')">新建物品放行条</el-button> 
        </el-button-group>
           ...
           >
            <template slot-scope="scope">  
              ...
              <div class="state state2" v-if="scope.row.status*1==5">已抄表</div> -->
               ...
               <span class="pdlr1 state state0" v-if="scope.row.status == 0">不同意</span>
              <span class="pdlr1 state state1" v-if="scope.row.status == 1">同意</span>
              <span class="pdlr1 state state2" v-if="scope.row.status == 2">经理审批</span>
              <span class="pdlr1 state state3" v-if="scope.row.status == 3">客服审批</span>
           </template>
        </el-table-column> 
        <el-table-column
          label="详情"
          ...
          min-width="9%"
           > 
           <template slot-scope="scope">
             <el-button  plain size="small" @click="turnTo('/estate/serviceList/wuye/release_pass/details?guid='+scope.row.guid)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <div id="printcode" v-show="print1">
        <el-table
          :data="orderList"
          border
          :style="{height:orderList.length*49+'px'}"> 
          <el-table-column
            prop="guid"
            label="单号"
            width="240px"
