<template>
  <div>
    <yd-layout class="layout_my bgwhite" style="min-height:500px;width:750px">
      ...
      <div class="title">
         ...
         <el-breadcrumb-item :to="{path: '/manage/wuye_service'}">物业服务单</el-breadcrumb-item>
          <el-breadcrumb-item @click.native="$router.back">返回</el-breadcrumb-item>
          <el-breadcrumb-item>选择报修类型</el-breadcrumb-item>
          </el-breadcrumb>
      </div>
      <div class="top_title"><div class="time-title h8" style="line-height:60px"><img src="../../../../../../assets/images/rent/my/add_new_job.png" alt="">请选择</div></div>
      <div class="type-this">
        <div v-for="(item,index) in qsTypes" style="width:120px;flex:initial" :key="index" @click="searchType(item.dictDataName,item.guid)">
          <div>{{item.dictDataName}}</div>
          <!-- <div><el-button type='primary'>{{item.dictDataName}}</el-button></div> -->
