    ...
    <div class="tableBox"  style="padding-top:10px;">
      <div> 
        <div style="float:left;margin-bottom:10px;">
          <span>状态：</span>
          <el-select @change='changeData1' v-model="value4" clearable placeholder="请选择" style="width:120px;">
            <el-option
        ...
        <el-button-group v-if="showBuild" style="float:right;margin-right:10px;">
          ...
          ' @click="$router.push('/estate/wuye/to_repair')">新建</el-button> 
      ...
      <el-table :data="orderList" height="250" border style="width: 100%">      
        ...
        <el-table-column prop="remark" label="备注" show-overflow-tooltip	 min-width="30%"> </el-table-column>
         <el-table-column prop="createDate" label="创建时间" show-overflow-tooltip min-width="18%" align="center"> </el-table-column>
        <el-table-column label="地点" min-width="15%"  align="center">
           <template slot-scope="scope">
            {{scope.row.customerInfo.ridName}}{{scope.row.customerInfo.unitName}}
           </template>
        </el-table-column>
        <el-table-column label="状态" align="center" min-width="11%">
          <template slot-scope="scope">
        ...
        <el-table-column label="详情" align="center" min-width="9%"> 
          <template slot-scope="scope">
            <el-button   plain size="small" @click="turnTo('/estate/wuye/order_detail?guid='+scope.row.guid)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <div id="printcode" v-show="print1">
        <el-table :data="orderList" border :style="{height:orderList.length*49+48+'px'}">      
          ...
          <el-table-column prop="remark" align="center" label="备注" show-overflow-tooltip	 width="544px"> </el-table-column>
          <el-table-column prop="createDate" label="创建时间" show-overflow-tooltip width="240px" align="center"> </el-table-column>
          <el-table-column label="地点" width="180px"  align="center">
            <template slot-scope="scope">
              {{scope.row.customerInfo.ridName}}{{scope.row.customerInfo.unitName}}
            </template>
          </el-table-column>
