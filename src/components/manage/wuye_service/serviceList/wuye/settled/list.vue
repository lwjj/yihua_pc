   ...
   <div class="layout_my newRightContent">
    <div class="title">
       <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>入驻</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox" style="padding-top:10px;">
      <div> 
        ...
        <el-button-group v-if="showBuild" style="float:right;margin-right:10px;">
          ...
          ' @click="turnTo('/estate/serviceList/wuye/settled/add')" v-if="userInfo.organType == 3" >新建</el-button> 
          <!-- <el-button class="ml2" type="primary" @click="$router.push('/estate/serviceList/waiqing/setting')">设置</el-button> -->
          <el-button icon='el-icon-plus
          ' @click="turnTo('/estate/serviceList/settled/add')" v-if="userInfo.organType == 1" >新建</el-button> 
        </el-button-group>
      ...
      <el-table :data="orderList" height="250" border style="width: 100%"> 
        <el-table-column prop="guid" label="单号" min-width="18%" align="center"></el-table-column>
        <el-table-column prop="remark" label="备注" :formatter="setRemark" show-overflow-tooltip	  min-width="12%"> </el-table-column> 
        <el-table-column prop="transactDate" label="办理时间" show-overflow-tooltip	 min-width="12%" align="center"> </el-table-column> 
        <el-table-column prop="startTime" :formatter="setTime" label="开始时间"  show-overflow-tooltip	  min-width="10%" align="center"> </el-table-column>
        <el-table-column prop="endtime" label="截止时间" :formatter="setTime" show-overflow-tooltip	  min-width="10%" align="center"> </el-table-column> 
        <el-table-column label="联系人"  show-overflow-tooltip	min-width="10%" align="center" prop='contactName' ></el-table-column>
        <el-table-column label="地点" show-overflow-tooltip	 min-width="9%" align="center" >
          <template slot-scope="scope" v-if="scope.row.clientInfo">
            {{scope.row.clientInfo.ridName}}{{scope.row.clientInfo.unitName}}
          </template>
        </el-table-column>
        <el-table-column label="状态"  min-width="9%" align="center" >
          <template slot-scope="scope">  
            ...
            <div class="state state2" v-if="scope.row.status*1==3">待抄表</div>
            <div class="state state2" v-if="scope.row.status*1==4">已抄表</div>
          </template>
        </el-table-column> 
        <el-table-column label="详情" min-width="10%" align="center"> 
          <template slot-scope="scope">
            <el-button plain size="small" @click="turnTo('/estate/serviceList/wuye/settle_detail?guid='+scope.row.guid)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <div id="printcode" v-show="print1">
        <el-table :data="orderList" border :style="{height:orderList.length*49+48+'px'}"> 
          <el-table-column prop="guid" label="单号" width="190px" align="center"></el-table-column>
          <el-table-column prop="remark" label="备注" align="center" :formatter="setRemark" show-overflow-tooltip	  width="223px"> </el-table-column> 
          <el-table-column prop="transactDate" label="办理时间" show-overflow-tooltip	 width="170px" align="center"> </el-table-column> 
          <el-table-column prop="startTime" :formatter="setTime" label="开始时间"  show-overflow-tooltip	  width="120px" align="center"> </el-table-column>
          <el-table-column prop="endtime" label="截止时间" :formatter="setTime" show-overflow-tooltip	  width="120px" align="center"> </el-table-column> 
          <el-table-column label="联系人"  show-overflow-tooltip	width="190px" align="center" prop='contactName' ></el-table-column>
          <el-table-column label="地点" show-overflow-tooltip	 width="210px" align="center" >
            <template slot-scope="scope" v-if="scope.row.clientInfo">
              {{scope.row.clientInfo.ridName}}{{scope.row.clientInfo.unitName}}
            </template>
          </el-table-column>
...
export default {
  data() {
    return {
      ...
      nowStatus: "",
      // qsStatus: ["上报中", "处 理中", "已分单", "已接单", "已完成", "已关闭"],
