   ...
   <div class="layout_my newRightContent">
    <div class="title">
       <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>装修单</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox">
      <div class="tableTop"> 
      ...
      <el-table-column
        ...
        <el-table-column
          ...
          width='180' 
           >
            <template slot-scope="scope"> 
              <span v-if="scope.row.status == 1" class="pdlr1 state state2">进行中</span>
              <span v-if="scope.row.status == 2" class="pdlr1 state state2">经理审批</span>
              <span v-if="scope.row.status == 3" class="pdlr1 state state2">处理中</span>
        ...
        <el-table-column
          label="详情"
           > 
           <template slot-scope="scope">
             <el-button type="primary" @click="turnTo('/estate/serviceList/wuye/renovation/details?guid='+scope.row.guid)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
