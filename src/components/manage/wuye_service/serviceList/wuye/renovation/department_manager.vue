<template>
  <yd-layout class="layout_my">
      ...
      <el-button @click='delPeople' type="primary">确定</el-button>
    </div>
    <div>
       <div class="title">
            ...
            <li class="child-bottom" @click="selectThis(index,no)" v-for="(item,no) in it.empList" :key="no" v-if="it.empList.length>0">
              ...
              <div style="flex:1">
                <div style="display: flex;justify-content: space-between">
                  <span class="l-center "> <span class="mr2">{{item.userName}} </span><span class="mr2" v-if="item.post">{{item.post}}</span>{{item.account}}</span>
    ...
    <div slot="bottom" class="flex-row bgwhite jusCenter bt h8 foCo6 font32" >
