<template>
  <div class="newRightContent" style="overflow:auto">
    <div class="border bgwhite">
      <yd-layout class="yd-layout" style="width:750px;" v-if="showUser">
        ...
        <div class="title">
         <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>发布装修单</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="inputText">
          <ul>
            <li><p class="font32">开始时间</p><span style="border:0">
            ...
            <li><p class="font32">结束时间</p><span style="border:0">
              <el-date-picker class="mr2"
                v-model="datetime1"
                type="date"
                :clearable='false'
           ...
           <div class="images">
              <ul>
                <yd-lightbox :num='imgUrl.length'>
                   <li v-for="(item,index) in imgUrl" class="relative" :key="index">
                   <yd-icon custom style="position:absolute;right:-.2rem;top:-.2rem;" @click.native.stop="deleteImg(index)" name='delete' size='.6rem'></yd-icon>
                     <img class="img" :src="item" alt=""></li>
                     <li class="relative">
                        <p  @click="addImg"><img style="width:1.28rem;height:1.28rem;" src="../../../../../../assets/images/rent/estate/photo.png" alt="">
      ...
      <div class="alertText" v-show="alertT">
        <ul>
            ...
            <li class="a"><p class="font28">人员名字：</p><span><input v-model="info.name" type="text" maxlength="8" placeholder="请填写"></span></li>
            <li class="a"><p class="font28">手机号码：</p><span><input  v-model="info.mobile" type="number" oninput='value = this.value.slice(0,11)' onkeyup='value = this.value.slice(0,11)' placeholder="请填写"></span></li>
            <li class="a">
               <p class="font28">身份证号：</p><span><input maxlength="18" v-model="info.decorationId" onkeyup='value = this.value.slice(0,18)' oninput='value = this.value.slice(0,18)' type="number" placeholder="请填写"></span>
              </li>
  ...
  methods: {
    ...
    submitForApply() {
      ...
      if (this.userInfo.organType == 1) {
        ...
        this.unit.guid = this.userInfo.unitId;
        this.rentUserName = this.userInfo.name;
        this.applyUserId = "0";
      }
      var data = {
