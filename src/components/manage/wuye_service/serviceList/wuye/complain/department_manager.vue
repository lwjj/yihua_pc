<template>
  <yd-layout class="layout_my yd-layout">
    <div >
          ...
          <ul v-show="it.showList">
            <li class="child-bottom" @click="selectThis(index,no)" v-for="(item,no) in it.empList" :key="no" v-if="it.empList.length>0">
              ...
              <!-- <router-link
                ...
                slot="left">
                <img v-if="showRightImg" class="l-right1 l-right-change" src="../../../../../../assets/images/rent/my/add_job.png"
                     alt="">
              </router-link> -->
            </li>
          </ul>
    ...
    <div slot="bottom" class="bgwhite pb2" @click='delPeople'>
       <el-button class="mt2 ml2" slot="bottom" type="primary" @click='delPeople'>确定</el-button>
    </div>
  </yd-layout>
</template>
<script>
