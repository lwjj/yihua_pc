    ...
    <yd-layout class="layout_my yd-layout" style="width:750px;" v-if="showUser && showAssign">
      ...
      <div class="title">
         <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>新建投诉建议</el-breadcrumb-item>
        </el-breadcrumb>
        </div>
      ...
      <div class="flex-row-nowrap bgwhite h8 pdlr2" v-if="userInfo.organType == 3">
      ...
      <div class="text-more">
       ...
       <div class="pd2">
         <el-button @click="sureToRepair">提交</el-button>
       </div>
    </yd-layout>
  ...
  data() {
    ...
    if (this.userInfo.organType == 1) {
      this.location =
        ...
        this.userInfo.ridName +
        this.userInfo.unitName;
    } else {
      this.location = "";
    }
