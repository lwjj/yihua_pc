  ...
  <yd-layout class="layout_my">
    ...
    <div class="inputText">
        <ul>
          ...
          <li><p class="font30">重要等级</p><span style="border:none"><yd-checkbox :color='mainColor' v-model="checkbox1"><span style="visibility:hidden">.</span></yd-checkbox></span></li>
        </ul>
    </div>
...
export default {
  ...
  methods: {
    ...
    submitForApply() {
      ...
      if (this.datetime0 == "")
        return this.$dialog.toast({ mes: "请选择接待时间" });
      if (this.receRess == "")
        return this.$dialog.toast({ mes: "请选择接待地点" });
      if (this.datetime0 == "")
        return this.$dialog.toast({ mes: "请选择接待内容" });
      var flag = true,
        arr = [];
