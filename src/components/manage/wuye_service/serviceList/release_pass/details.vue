  ...
  <yd-layout class="layout_my">
    ...
    <div class="mask" v-if="showCode" @click="showCode = false">
     ...
     <div class="text" v-show="releasePassRowList.length>0">
      ...
      <div>
        <yd-lightbox :num="releasePassRowList.length">
          <i v-for="(item,index) in releasePassRowList" style="width:1.2rem;height:1.2rem" v-if="item.images" :key="index">
            <!--<img alt="">-->
            <yd-lightbox-img style="width:1.2rem;height: 1.2rem;" class="img" :src="item.images"></yd-lightbox-img>
          </i>
