      ...
      <el-table
        ...
        <el-table-column
          label="详情"
           > 
           <template slot-scope="scope">
             <el-button type="button" class="el-button el-button--default el-button--small is-plain" @click="turnTo('/estate/wuye/order_detail?guid='+scope.row.guid)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
.tableTop div:nth-of-type(2){
	position: absolute;
	top: 20px;
	left: 290px;
}
.tableTop div:nth-of-type(3){
	right: 20px;
	position: absolute;
	top: 20px;
}
