<template>
  <div>
    <yd-layout class="layout_my" v-show='isShow'>
      <yd-navbar class="header" slot="navbar" v-show="!userAgent.isWX" v-title="'报修单'" title="报修单" color="#fff"
                 :bgcolor="mainColor"
                 height=".88rem">
      ...
      <div class="flex-row-nowarp bgwhite h8 flex-start" style="padding-right:.6rem" @click='setShow()'>
        ...
        <input class="clear-input" style="height:.65rem" readonly v-bind:placeholder=typeName v-model="typeName"
               type="text">
      ...
      <div class="text-more">
        ...
        <div class="show-send-pic">
          ...
          <div class="logo-img-div">
            ...
            <input class="file hid-input" name="file[]" type="file" accept="image/jpeg,image/png,image/jpg"
