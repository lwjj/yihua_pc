...
<div class="inform_table">
   <el-table
    ...
    width="120px"
      ...
      >
      <template slot-scope="scope"> 
        <el-button type="primary" plain size="small" @click="turnTo('/manage/wuye_contact/wuye_inform/inform_del/'+scope.row.guid)">详情</el-button>
