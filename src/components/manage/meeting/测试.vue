...
<!-- 会议表单 -->
   <div class="task_content" v-for="(item,index) in taskList" :key="index"  @click="turnTo('/manage/meeting/meet_del')">
     <div class="task_header">
      <span class="el-icon-tickets"></span>
      <span class="type">范围:工程部</span>
      <!-- <span class="state" v-show="true">已阅</span> -->
     </div>
     <div class="task_main">
       <p>关于招聘人员的培训事项</p>
          <span class="apply">记录人:蒋委员长</span>
       <div class="time">
