...
<div id='quality'>
    <div class="title">
        ...
        <!-- <div class="text">房屋信息</div> -->
         <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item v-if="$route.query.back==1" @click.native='$back'>返回</el-breadcrumb-item>
            <el-breadcrumb-item v-if="$route.query.back!==1" :to="{path: '/manage/building'}">楼宇信息</el-breadcrumb-item>
    ...
    <div class="layout"> 
        <div class="filtrate">
            ...
            <el-button style="margin-left:0;" @click="turnTo('/manage/manage_building/building_msg')">房屋信息</el-button>
            </div>
        </div>    
  <!-- 表单 -->
<div class="inform_table">
   <el-table
    ...
    header-align="center"
      ...
      >
      <template slot-scope="scope">
        <el-button  plain size="small" @click="turnTo('/manage/manage_building/building_del/'+scope.row.guid)">详情</el-button>
      </template>
    </el-table-column>
  </el-table>
 </div>
