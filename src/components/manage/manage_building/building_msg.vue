...
<div id='inform_del' >
    <div class="title">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/manage/manage_building/building_unit' }">房屋信息</el-breadcrumb-item>
            <el-breadcrumb-item>所有信息</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
       <el-button type="primary" class="floatR mr2 mt2 addDong" size="" @click.native="openAddRid">添加栋</el-button>
   <div class="layout" v-if="loading">
        ...
        <el-tabs class="tabtransform" v-model="activeName" @tab-click="handleClick">
          <el-tab-pane v-for="(item,index) in ridList" :key="index" :label="item.ridName" :name="String(index)">
            <el-button type="primary" class="floatR mb2" size="" @click="openUnit(item.guid)">添加单元</el-button>
            <el-button type="primary" class="floatR mr2 mb2" size="" @click="openEditRid(item)">编辑此栋</el-button>
                  <!-- 租户信息表单 --> 
      ...
      <!-- 添加栋 编辑栋 -->
            <el-dialog :title="isAddRid==1?'新增栋':'编辑' + `栋名称`" :visible.sync="dialogFormVisible" width="450px" top="15vh">
        <el-form>
          <el-form-item label="">
            <el-input :maxlength="20" v-model="ridName"></el-input>
          </el-form-item>
        </el-form>
      ...
      <!-- 添加 编辑 单元 -->
        ...
        <el-form label-width="80px">
          <el-form-item label="单元号">
            <el-input v-model="unitName" :maxlength="20"></el-input>
          </el-form-item>
          <el-form-item label="建筑面积">
            <el-input v-model="areas" type="number" :maxlength="5"></el-input>
          </el-form-item>
          <el-form-item label="业主姓名">
            <el-input v-model="ownName" :maxlength="20"></el-input>
          </el-form-item>
