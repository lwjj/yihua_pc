  ...
  <div class="newRightContent">
    ...
    <div class="layout">
      ...
      <div style="background:#fff;margin-top:10px;padding:10px;">
          ...
          <div> 
            <el-select v-model="value1" :clearable="true" placeholder="请选择省" @change="handleChange(2,value1)">
              <el-option
          ...
          <div v-if="showDis1">
            <el-select v-model="value2" :clearable="true" placeholder="请选择市" @change="handleChange(3,value2)">
              <el-option
          ...
          <div v-if="showDis2">
            <el-select v-model="value3" :clearable="true" placeholder="请选择区/县" @change="handleChange(4,value3)">
              <el-option
          ...
          <div v-if="showDis3">
            <el-select v-model="value4" :clearable="true" @change="handleChange(5,value4)" placeholder="请选择片区">
              <el-option
...
export default {
  ...
  methods: {
    ...
    toGqDetail(row) {
      ...
      if (row.type * 1 == 3) {
        this.$router.push(
          "/user/we_business/supply/proService?type=" +
            row.type +
            "&guid=" +
            row.guid
        );
        ...
        this.$router.push(
          "/user/we_business/supply/gjDetail?type=" +
            row.type +
            "&guid=" +
            row.guid
        );
    ...
    handleChange(type, guid) {
      ...
      console.log(type, guid,"type, guid")
      // 当清空数据时显示上一个数据
      if (!guid) {
        switch (Number(type)) {
          case 2:
      ...
      this.$ajax(
        ...
        res => {
          if (this.guid == 1) {
            ...
            // var obj = { label:"全部",value: "ALL" };
            //     this.tipType.unshift(obj);
            ...
            var obj = { label:"全部",value: "ALL",children:[] };
                this.tipType.unshift(obj);
          ...
          if (res.data.length > 0) {
            switch (type) {
              case 1:
                ...
                var obj = { dictDataName: "全国",dictDataValue:"全国", guid: "ALL" };
                this.options1.unshift(obj);
                console.log(this.options1,"9999999999999999999")
                break;
              case 2:
                this.options2 = res.data;

                var obj = { dictDataName: "全部",dictDataValue:"全部", guid: "ALL" };
                this.options2.unshift(obj);

                if(this.value1 == "" || this.value1 != "ALL"){
                  this.showDis1 = true;
                }else{
                  this.showDis1 = false;
                }
                ...
                console.log(this.showDis1,"value1")
                break;
              case 3:
                ...
                if(this.value2 == "" || this.value2 != "ALL"){
                  this.showDis2 = true;
                }else{
                  this.showDis2 = false;
                }
                console.log(this.value2,"value2")
                console.log(this.showDis2,"value2")
                // this.showDis2 = true;
                break;
              case 4:
                this.options4 = res.data;
                var obj = { dictDataName: "全部",dictDataValue:"全部", guid: "ALL" };
                this.options4.unshift(obj);

                if(this.value3 == "" || this.value3 != "ALL"){
                  this.showDis3 = true;
                }else{
                  this.showDis3 = false;
                }
              ...
              case 5:
                ...
                if(this.value4 == "" || this.value4 != "ALL"){
                  this.showDis4 = true;
                }else{
                  this.showDis4 = false;
                }
    ...
    getList() {
      ...
      if (this.scopeValue && this.scopeValue !="ALL"){
      ...
      // 设置发布的行业类型
      if (this.selectedOptions2.length == 0 || this.selectedOptions2 == "ALL" ) {
