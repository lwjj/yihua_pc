<template>
  <div id="new_progress">
    ...
    <div class="main">
      ...
      <div class="content" style="padding:10px;height:calc(100% - 110px)">
          <el-table :data='tipList' height="calc(100% - 40px)" @selection-change="selectCustom" border>
          ...
          <div class="elPagination mt1" v-if="tipList.length>0">
            <el-button v-if="value2*1==0" size="mini" type="danger" @click="delItem(1)">加黑</el-button>
            <el-button v-if="value2*1==1" @click="delItem(0)" size="mini" type="danger">移除</el-button>
            <el-button v-if="value2*1==0" @click="delItem(2)" size="mini" type="danger">删除</el-button>
            <el-pagination
              v-if="bm.rowCount"
              background
              style="float:right;"
