  ...
  <div id="new_progress">
    ...
    <el-col class="content">
      <el-col style="line-height: 36px;margin-bottom: 5px"> 
        ...
        <el-col style="width: 180px;margin-bottom: 5px; padding-left: 20px">
          <el-input v-model="input" placeholder="请输入搜索关键字" @keyup.enter.native='getList' @input.native='getCurrent'></el-input>
        </el-col>
        <el-col style="width: 80px;padding-left: 15px">
      ...
      <el-col v-if="tipList.length>0" v-for="(item,index) in tipList" :key="index" class="tip-detail"
        ...
        <el-col>
          ...
          <!--<el-col :span="1">-->
            <!--&nbsp;-->
          <!--</el-col>-->
          <el-col :span="8" @click.native="toGqDetail(3,item.poId)"
  ...
  methods: {
    ...
    dateChange() {
      ...
      if (this.dateValue != null) {
        ...
        this.bm.endTime = this.dateValue[1].format("yyyy-MM-dd") + " 23:59:59";
      } else {
        this.bm.startTime = "";
        this.bm.endTime = "";
      }
    ...
    getList() {
      var data = {
        ...
        type: 2,
        title: this.input,
        startTime: this.bm.startTime,
        endTime: this.bm.endTime
      };
