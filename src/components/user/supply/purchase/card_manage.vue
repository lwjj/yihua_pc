<template>
  <div id="new_progress">
    <div class="title">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>名片管理</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
  <div class="edit" style="height:auto;">
    <div class="declares" style="margin-bottom:.2rem;">
        ...
        <ul>
            <li><p>联系人</p><span><input v-model="pm.name" maxlength="20" type="text"></span></li>
            <li><p>手机号码</p><span><input v-model="pm.phone" oninput="if(value.length>11)value=value.slice(0,11)" type="number" ></span></li>
            <li><p>联系QQ</p><span><input oninput="if(value.length>15)value=value.slice(0,15)" v-model="pm.qq" type="number"></span></li>
            <li><p>联系邮箱</p><span><input v-model="pm.email" type="text" maxlength="30"></span></li>
            <li><p>固定电话</p><span><input v-model="pm.telePhone" maxlength="20" type="text"></span></li>
            <li><p>详情地址</p><span><input v-model="pm.address" maxlength="50" type="text"></span></li>
            <li><p>所在大厦</p><span><input v-model="pm.building" maxlength="50" type="text"></span></li>
        </ul>
    </div>
    ...
    <div class="declares">
        <ol>
            <li sytle="color:#666"><p>企业介绍</p><span>
                <a style="padding:.07rem .2rem;border-radius:.05rem;font-size:.24rem;color:white;" :style="{background:mainColor}">{{vipGrade}}</a></span></li>
        </ol>
        <ul style="border-bottom:1px dashed #D9D9D9;">
            ...
            <li><p>成立时间</p>
              <span style="border:0">
                <el-date-picker
                  v-model="pm.foundinTime"
                  format="yyyy-MM-dd"
                  value-format="yyyy-MM-dd"
                  type="date"
                  placeholder="选择日期">
                </el-date-picker>
               <!-- <yd-datetime type="date" v-model="pm.foundinTime" slot="right"></yd-datetime> -->
              </span>
            </li>
            <li><p>注册资本</p><span><input v-model="pm.capital" oninput="if(value.length>11)value=value.slice(0,11)" type="number"></span></li>
            <li><p>所属行业</p><span><input v-model="pm.industry" maxlength="50" type="text"></span></li>
            <li><p>法人代表</p><span><input v-model="pm.representative" maxlength="50" type="text"></span></li>
            <li><p>经营模式</p><span><input v-model="pm.pattern" maxlength="50" type="text"></span></li>
            <li><p>员工人数</p><span><input v-model="pm.peopleNum" oninput="if(value.length>11)value=value.slice(0,11)" type="number"></span></li>
            <li><p>年营业额</p><span><input v-model="pm.turnover" oninput="if(value.length>11)value=value.slice(0,11)" type="number"></span></li>
            <li><p>企业官网</p><span><input v-model="pm.website" maxlength="50" type="text"></span></li>
            <li><p>微信号</p><span><input v-model="pm.weChat" maxlength="50" type="text"></span></li>
        </ul>
    ...
    <div class="declares" style="margin-bottom:.2rem;">
        ...
        <div class="textar" style="margin-top:.2rem;">
          <el-input type="textarea" :autosize="{ minRows: 3}" :placeholder="pm.describes" v-model="pm.describes" :maxlength="100">
          </el-input>
        </div>
        <div style="padding-bottom:20px;margin-top:5px;float:right;padding-right:.4rem">{{pm.describes.length}}/100</div>
        <div style="clear:both"></div> 
    </div>

    <div class="to-select">
      <div class="buttonBox">
        <yd-button size="small" class="send" @click.native="addOrEditShopCard" :bgcolor="mainColor" color='#fff'
                   type="primary">
          保存
        </yd-button>
      </div>
...
export default {
  data() {
    ...
    return {
      ...
      logo:
        'this.src="' +
        require("../../../../assets/images/rent/supply/photo.png") +
        '"',
      picked: false,
      peopleNum: "",
      organInfo,
  ...
  methods: {
    ...
    addOrEditShopCard() {
      if (
        ...
        this.$ajax1(
          `${this.subUrl.bd}/opportunity/addOrEditShopCard?token=` +
            this.$getkey(),
          data,
          res => {
            if (res.code == 1) {
