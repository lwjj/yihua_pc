    ...
    <div id="library">
        <div class="title">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>上传文库</el-breadcrumb-item>  
            </el-breadcrumb>
        </div>
        <div class="layout">
                ...
                <div class="library_right">
                    <div class="library_radio">
                        ...
                        <el-radio class="radio1" v-model="radio" :label="1">
                            商机点
                            <el-input type="number" style="width:150px;" v-model="expectBp" :maxlength="10"></el-input>
                        </el-radio>
...
export default {
  ...
  methods: {
    ...
    getMain() {
      ...
      this.uploadContent.publishType = this.uploadPosition;
    },
    uploadAll() {
      var reg = /^[0-9]*$/;
      var a = [];
      ...
      if (this.uploadContent.title == "") {
        ...
        var data = {
          ...
          typeId: this.value11,
          publishType: this.uploadContent.publishType,
        ...
        this.$ajax1(
          `${this.subUrl.bd}/knowAll/addknowAll?${this.$qs.stringify(data)}`,
          a,
          res => {
