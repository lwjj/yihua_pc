    ...
    <div class="library_box">
        ...
        <div class="library_box_table">
            <el-table ref="multipleTable" height="100%" @selection-change="handleSelectionChange" :data="tableData4" style="width:100%" border>
                ...
                <el-table-column prop="createDate" label="日期" min-width="20%"></el-table-column>
                ...
                <el-table-column prop="kaId" label="编辑" min-width="7%">
                    <template slot-scope="scope">
                        <el-button @click.native.prevent="goEditor(tableData4,scope.row)" type="text">
                            编辑
                        </el-button>
                    </template>
                </el-table-column>
  ...
  methods: {
    ...
    goView(kaid, rows) {
      this.$router.push({
        ...
        params: { hid: rows.guid, road: 3 }
      });
    },
    goEditor(kaid, rows) {
      console.log(rows);
      this.$router.push({ name: "library_editor", params: { hid: rows.kaId } });
    },
