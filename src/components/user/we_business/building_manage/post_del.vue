...
<div id='inform_del'>
    <div class="title">
        <!-- <div class="text"><i @click="back" class="el-icon-arrow-left"></i>物业关系详情</div> -->
         <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/user/we_business/building_manage' }">楼圈管理</el-breadcrumb-item>
    ...
    <div class="del">
        <div class="del_title">  
           <!-- 状态（1，正常,2，关闭(下架),3过期） , -->
            ...
            <span v-if="del.status==4">状态：待审核</span>
        </div>
    ...
    <div class="del">
     ...
     <div class="recommend" v-if="del.status == 4">
            <el-button type="danger" plain @click="refuse">拒绝</el-button>
            <el-button type="primary" @click="yes">通过</el-button>
      </div>
</div>
      <!-- 选择商家 -->
...
//      bsUserIds: null
      ...
      this.$ajax(
        `${this.subUrl.bd}/buildingBuy/PassDirectly`,
        data,
        res => {
          console.log(res, "yes");
