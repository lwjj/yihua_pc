   ...
   <div class="layout_my newRightContent">
    <div class="title">
       <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>项目月报</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox">
      <div class="tableTop"> 
      ...
      <el-table-column
        ...
        <el-table-column
          ...
          width='120' 
           >
           <!-- （0：未上报，1：已上报,2:未阅，3：已阅） , -->
            <template slot-scope="scope">  
              <div  class="state stateClose" v-if="scope.row.status*1==0">未上报</div>
              <div class="state state1" v-if="scope.row.status*1==1">已上报</div>
              <div  class="state state2" v-if="scope.row.status*1==2">未阅</div>
              <div class="state state2" v-if="scope.row.status*1==3">已阅</div> 
           </template>
        </el-table-column> 
        <el-table-column
          label="详情"
           > 
           <template slot-scope="scope">
             <el-button type="primary" @click="turnTo('/wuye/month/detail/'+scope.row.guid)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    getQuestionInfo(cb) {
      ...
      if (this.value3 > -1) data.manageOrganId = this.value3;
      this.xhr
        .post(
          `${this.subUrl.activity}/manageMonRep/listMonthRepByPm`,
