  ...
  <div class="layout_my newRightContent">
    <div class="title">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>物业稽查</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="tableBox">
      <div class="tableTop">
        ...
        <el-button-group>
          ...
          ' @click="$router.push('/user/audit_report')">新建
          </el-button>
        </el-button-group>
      </div>
      <el-table
        ...
        >
          <template slot-scope="scope">
            <el-button type="primary" @click="turnTo('/user/inspection_details?guid='+scope.row.guid)">详情</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
          ...
          .then(res => {
            if (res.data.code == 1) {
              ...
              for (var i = 0; i < this.orderList.length; i++) {
                switch (this.orderList[i].status * 1) {
                  case 0:
                    this.orderList[i].status1 = '草稿';
                    break;
                  case 1:
                    this.orderList[i].status1 = '已下发';
                    break;
                  case 2:
                    this.orderList[i].status1 = '已回复';
                    break;
                  case 3:
                    this.orderList[i].status1 = '关闭';
                    break;
                }
              }
              cb && cb();
