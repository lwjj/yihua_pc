   ...
   <div class="layout_my newRightContent">
    <div class="title">
       <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>物业通知</el-breadcrumb-item>
        </el-breadcrumb>
    </div> 
    <div class="tableBox">
      <div class="tableTop"> 
        ...
        <el-button-group>
          ...
          ' @click="turnTo('/wuye/message/add')">新建</el-button> 
        </el-button-group>
      </div>
      <el-table
        :data="orderList"
        ...
        <el-table-column
          label="详情"
           ...
           <template slot-scope="scope">
             <el-button type="primary" @click="turnTo('/wuye/message/detail?guid='+scope.row.guid)">详情</el-button>
           </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    getQuestionInfo(cb) {
      ...
      if (this.value2) data.keyword = this.value2;
