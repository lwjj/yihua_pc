...
<div class="newRightContent">
  ...
  <yd-layout v-show="showshow" style="width:750px" class="yd-layout ">
    <!-- <div class="blue_box" >
    ...
    <div class="details">
        <div class="inputText" style="margin-bottom:.2rem;">
          <ul>
            ...
            <p class="font30">标题</p>
            <span>
              <el-input type="text" v-model="parameter.title" placeholder="" maxlength="30"></el-input>
            </span>
          </li>
          <li><p class="font30">关键字</p>
              <span><el-input type="text" v-model="parameter.keyword" placeholder="" maxlength="30"></el-input></span></li>
          </ul>
        </div>
        <div class="ss">
        ...
        <div class="images">
            ...
            <p v-show="show1" @click="addImg"><img src="../../../../assets/images/rent/estate/photo.png" alt="">
             <input class="file" name="file" type="file" accept="image/jpeg,image/png" @change="update"/></p>
        </div>
    </div>

    <yd-button-group slot="tabbar" style="margin-bottom:.2rem;padding:20px;">
        <!-- <yd-button :bgcolor="mainColor"  @click.native="savePyNotice" color="#fff" size="large" type="primary">确定</yd-button> -->
        <el-button :bgcolor="mainColor"  @click="savePyNotice" color="#fff" type="primary">确定</el-button>
    </yd-button-group>
  ...
  methods: {
    ...
    savePyNotice() {
      ...
      (data.keyword = this.parameter.keyword),
        ...
        this.xhr
          .post(
            `${this.subUrl.activity}/propertyNotice/savePyNotice`,
            qs.stringify(data)
          )
          .then(res => {
            if (res.data.code == 1) {
