    ...
    <div class="main">
        <div class="box">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/user/personal_wealth/personal_ticket/personal_account' }">收款账户</el-breadcrumb-item>
                ...
                if(this.pwdOk==1){
                    ...
                    res=>{
                        if(res.code==1){
                            ...
                            this.$router.push({path: '/user/personal_wealth/personal_ticket/personal_account'});
                        }else{
                            this.$message({
                                message: '请填写完整数据',
                                type: 'error'
