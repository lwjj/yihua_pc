    ...
    <div class="main">
        <div class="box">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item :to="{ path: '/user/personal_wealth/personal_BusinessModule/personal_BusinessModule/:guid/:name/:title/:sjd' }">业务办理</el-breadcrumb-item>
...
export default {
  ...
  mounted() {
    ...
    if (this.guid == undefined) {
      this.$router.push({ name: "personal_BusinessModule" });
      this.$message({
        message: "请选择要开通的业务",
        type: "warning"
      });
