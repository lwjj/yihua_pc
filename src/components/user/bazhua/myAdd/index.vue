  ...
  <div id="new_progress">
    <div class="title">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item class="cursor" to="/user/we_business/bazhua/circle">我的圈子</el-breadcrumb-item>
    ...
    <el-col class="content">
      <div class="topTitle">
        ...
        <div class="flex">
          <el-input class="mr1" v-model="input" placeholder="请输入帖子标题"></el-input>
      ...
      <div class="tip-detail mt1 cursor"  v-if="tipList.length>0 &&item.bbs" @click='toDetail(item.userId,item.bbs.guid,item.bbs.status)' v-for="(item,index) in tipList" :key="index">
