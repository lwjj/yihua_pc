<template>
        <div class="box">
            <div class="main">
                <!-- <div class="first1">
                    <el-button style="margin-left:100px;" @click="selectType(1)">通过原密码修改</el-button>
                ...
                <div class="first1">
                    <div v-if="type==1">
                        ...
                        <div style="font-size:13px;color:#999;margin-left:100px;">为了保障你的数据安全，修改密码前请填写原密码</div>
                        <div>
                            <span>原密码</span>
                        ...
                        <div>
                            <span>设置新密码</span>
                            <el-input v-model="pwd2" type="password" :maxlength="16" placeholder="请输入8-16位字母加数字新密码"></el-input>
                        </div>
                        <div>
                            <span>确认新密码</span>
                            <el-input v-model="pwd3" type="password" :maxlength="16" placeholder="请输入密码"></el-input>
                        </div>
                        <div style="">
                            <el-button style="width:360px;margin-left:100px;" @click="forget(1)">确定</el-button>
                        </div>
                    </div>
                    <div v-if="type==2">
                        <div style="margin-left:100px;">
                        ...
                        <div>
                            <span>新密码</span>
                            <el-input v-model="forget3" type="password" placeholder="请输入8-16位字母加数字新密码"></el-input>
                        </div>
                        <div>
                            <span>确认新密码</span>
                        ...
                        <div style="">
                            <el-button style="width:360px;margin-left:100px;" @click="forget(2)">确定</el-button>
                        </div>
                    </div>    
                </div>
            </div>
  ...
  methods: {
    ...
    forget(num) {
      if (num == 2) {
        ...
        if (!this.pwd1) return this.$message.error("请输入原密码");
        if (!this.pwd2) return this.$message.error("请输入新密码");
        if (!this.pwd3) return this.$message.error("请输入确认新密码");
        console.log(this.pwd2, this.pwd3);
        if (this.pwd3 != this.pwd2)
          return this.$message.error("两次密码不一致");
        if (!this.reg.test(this.pwd2))
