...
<div id='subTemplate'>
  ...
  <div class="container" v-show="show">
     ...
     <el-form-item label="标题" prop="title">
        <el-input  style="width:100%" v-model="title" placeholder="请输入标题"></el-input>
    </el-form-item>
    ...
    <div class="inform_table">
      <el-table
        ...
        header-align="center"
          ...
          <template slot-scope="scope">
            <el-input type="textarea"  :autosize=" {minRows: 1}" v-model="scope.row.workContent"></el-input>
          </template>
        </el-table-column>
        <el-table-column
        header-align="center"
          ...
          >
          <template slot-scope="scope">
            <el-input type="textarea" :autosize=" {minRows: 1}" v-model="scope.row.workMeasure"></el-input>
          </template>
        </el-table-column>
        <el-table-column
        header-align="center"
      ...
      <div class="mingxi">
        <el-button @click="show=false;showMingxi=true" size="small">明细说明</el-button>
