...
<div class="newRightContent"> 
 <div class="border bgwhite" v-show="showAdd">
    <div class="title">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{path: '/mechant/administrator'}">管理员</el-breadcrumb-item>
        <el-breadcrumb-item>人员信息</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <yd-layout class="yd-layout" style="width:750px;overflow:hidden" >
      ...
      <div class="list-top">
          <el-button style="margin:20px;" type="primary" @click="addUser">新增</el-button>
...
export default {
  ...
  methods: {
    ...
    sendToOne() {
      ...
      console.log(arr);
      if (arr.length == 0) {
        return this.$message({ type: "error", message: "请选择用户" });
      }
      let params = {
        token: this.$getkey(),
        organId: this.organInfo.guid,
    ...
    submitHandler(value) {
      ...
      if (flag) {
        this.$message({ type: "error", message: `此员工不存在` });
      }
      var arr = this.passW;
      this.passW = [];
      this.passW = arr;
