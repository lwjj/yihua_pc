...
<div id='new_progress'>
    ...
    <div class="layout clearfix">
        <!-- 最新进度 -->
    <div class="new_progress clearfix">
        <div class="tip">最新进度</div>
        <div class="sideBar">
           <!-- <div class="circle_bar cursor" @click="filterDeptId(false)">
             <el-progress type="circle" :percentage='0'></el-progress>
             <div class="text">所有</div>
           </div> -->
          <div class="circle_bar cursor" v-for="(item,index) in statistics" :title="item.typeName" @click="filterDeptId(item)" :key="index">
...
export default {
  ...
  methods: {
    filterDeptId(e) {
      ...
      this.$router.push(`/task/taskStatics?${this.$qs.stringify(data)}`);
    },
    changePage(e) {
      this.pageNo = e;
      this.getTask();
