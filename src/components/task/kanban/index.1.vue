       ...
       <div class="border content bgWhite">
           ...
           <div class="box" v-if="info.watchBillDtoList">
               ...
               <div class="list"  @click="turnTo('/manage/emergency')">
                   <div class="top">
                       <img width="60" height="61" src="../../../assets/images/task-icon/cha.png" alt="">
                       <span>突发事件</span>
                   </div>
               ...
               <div class="list" @click="turnTo('/manage/quality')">
                   <div class="top">
                       <img width="60" height="59" src="../../../assets/images/task-icon/jicha.png" alt="">
                       <span>品质稽查</span>
                   </div>
                   <!-- <div class="center" v-for="(item,index) in info.emergencyBillList" v-if="index<2" :key="index">{{item.eventDetail}}</div> -->
               </div>
...
.box:nth-child(2) > .list:nth-child(2) {
  background: #ff6564;
}
.box:nth-child(2) > .list:nth-child(3) {
  background: #5781fc;
}
</style>
