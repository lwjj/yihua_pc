  ...
  <div class="newRightContent" style="overflow:auto">
    ...
    <div class="relative bgwhite" style="height:100%;padding:20px 0;">
        <div style="padding: 0 10px;background: #fff;margin-top: 10px">
          ...
          <!-- 发布范围 -->
          <div class="list_item" v-if="userInfo.organType == 1 || userInfo.organType == 3 || userInfo.organType == 4">
          ...
          <!-- 管理处发布到物业公司 -->
          <div class="list_item" v-if="showCompanyList && (userInfo.organType == 1 || userInfo.organType == 3)">
            <div class="label">物业公司</div>
             <el-select v-model="bsIndex3" @change='chooseWuye' class="flex1" placeholder="请选择物业公司">
                <el-option
          ...
          <!-- 物业公司发布到管理处 -->
          <div class="list_item" v-if="userInfo.organType == 4 && showManagementList">
            <div class="label">管理处</div>
             <el-select v-model="bsIndex3" @change='chooseWuye' class="flex1" placeholder="请选择管理处">
                <el-option
...
export default {
  ...
  data() {
    ...
    return {
      ...
      showManagementList:false,//是否显示管理处列表
      showXieyi: false,
      bsIndex: 0, //帖子类型大类
      bsIndex1: "", //帖子类型子类
      bsIndex2: "", //发布范围
  ...
  methods: {
    ...
    sendPost() {
      ...
      // 如果子类为空，只选择大类
      if (this.bsIndex1 === "") {
        console.log(this.bsIndex1,"this.bsIndex1")
      ...
      //发布范围
      if (this.userInfo.organType != 5) {
        if (this.disList[this.bsIndex2].scope == 6) {
          if (this.bsIndex3 === "") {
            data.scope = 6;
            data.scopeValue = 0;
          } else {
            ...
            data.scopeValue = this.companyList[this.bsIndex3].organId;
          }
