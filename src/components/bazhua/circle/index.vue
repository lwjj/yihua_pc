  ...
  <div id="new_progress">
    <div class="title">
      ...
      <el-breadcrumb separator-class="el-icon-arrow-right">
        <el-breadcrumb-item :to="{ path: '/user/we_business/bazhua/circle' }">八爪圈</el-breadcrumb-item>
     ...
     <el-col class="content">
      ...
      <el-col class="titleSet"  :span="24" style="margin: 10px 0">
        ...
        <el-col :span="24" v-if="userInfo.organType == 3 && userInfo.postType == 2" style="margin: 10px 0">
          <el-col :span="24">
            ...
            <el-col :span="20"  >
              <template>
                <el-select class='w20' v-model="value9" placeholder="请选择" @change="handleChange3()">
                  <el-option
      ...
      <el-col  v-for="item in tipList" :key="item.guid" class="tip-detail titleSet"
        ...
        <el-col :span="24" style="line-height: 30px;cursor: pointer" @click.native="toDetail(item.userId,item.guid)">
          <!-- <el-col :span="4">【{{item.typeName}}】</el-col> -->
          <el-col :span="18"><span class="font600 foCo6" style="font-size:14px;">【{{item.typeName}}】{{item.title}}</span></el-col>
    ...
    getbbsType() {
      ...
      this.$ajax(
        ...
        res => {
          ...
          var obj = { dictDataName: "全部",dictDataValue: "全部",index: "ALL",guid: "ALL" };
    ...
    getList() {
      ...
      */
      ...
      if (this.value6.length > 1) {
        data.bbsType = this.tipType[this.value6[0]+1].childDictData[
          this.value6[1]
        ].guid;
        ...
        if(this.value6 == 'ALL'){
          ...
          data.typePid = this.tipType[this.value6[0]+1].guid;
        }
      ...
      if(userInfo.organType == 3){
        data.roleType = 1
      } else if(userInfo.organType == 4){
        data.roleType = 0
      } else {
        data.roleType = ''
      }
