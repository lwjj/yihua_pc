    ...
    <yd-layout class="yd-layout" style="width:750px" v-show="showUser">
      ...
      <div class="mt2 bgwhite bt bb tableList" style="padding: .1rem 0;">
        <div class="flex-row-nowarp list_item  h8">
          ...
          <el-input class="flex1" placeholder="请输入标题" v-model="title" :maxlength="30"></el-input>
      ...
      <div class="mt2 bgwhite bt bb" style="padding: .3rem .24rem;">
        <el-input type="textarea" :maxlength="600" placeholder="请输入详情" :autosize="{ minRows: 6, maxRows: 6}" height="100px" v-model="detail"></el-input> 
        <!-- <yd-textarea maxlength="300" class="border radius" v-model="detail"
                     style="height: 1.6rem;padding:0.1rem 0.1rem .3rem"></yd-textarea> -->
        <div style="width: 100%;background:#fff;display: flex;" class="mt2">
...
// "@/components/rent/estate/serviceList/renovation/department_manager";
