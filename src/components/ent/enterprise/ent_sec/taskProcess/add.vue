...
<div class="newRightContent">
 <div class="bgwhite border" style="height:100%;overflow:auto">
    <div class="yd-layout" style="width:750px" v-show="showUser && showTable &&showMuti">
      ...
      <div class="usuallyBox bb" style="padding: .1rem 0 .1rem;">
        <div class="list_item">
          ...
          <el-input class="flex1" :maxlength="30" v-model="title"></el-input>
          <!-- <input type="text" maxlength="30" class="flex1" v-model="title"> -->
        </div>
        <div class="list_item" >
          <div class="label">类型</div>
          <el-select class='flex1' v-model="value" @change="confirmFn" placeholder="请选择">
              <el-option
                v-for="(item,index) in pickData1.pData1"
                :key="index"
      ...
      <div class="mt2 bt bb usually2" style="padding: .3rem .24rem;">
        ...
        <el-input type="textarea" :maxlength="100" v-model="summarize" :placeholder="'任务详情'" :rows='5'></el-input>
        <!-- <yd-textarea maxlength="100" :placeholder="'任务详情'"
                     class="border bgwhite radius" v-model="summarize"
                     style="height: 2rem;padding:0.1rem 0.1rem .3rem"></yd-textarea> -->
        ...
        <div style="width: 100%;background:#fff;display: flex;">
          ...
          <div class="show-send-pic mt2" style="margin-top: 0;">
      ...
      <div class="usuallyBox mt2 bt bb" style="padding: .1rem 0 .1rem;margin-bottom:.2rem">
        <div class="bgwhite font28 bb h6 pdlr2" style="margin-bottom:.1rem;line-height:.6rem;">
          执行人信息
        </div>
        <div class="list_item" @click="showMuti=false">
          <div class="label">执行人</div>
          <input type="text" maxlength="30" readonly class="border h7" style="flex:1" placeholder="请选择" v-model="executorIdListName">
        </div>
        <div class="list_item" @click="showUser=false">
          <div class="label">验证人</div>
          <input type="text" maxlength="30" readonly class="border h7" style="flex:1" placeholder="请选择（不选择默认为自己）" v-model="rentUserName">
        </div>
      </div>
      <div class="flex-row-nowarp h9 bt bb jusCenter bgwhite font30" v-if="!($route.query.guid)" slot="bottom"
...
export default {
  ...
  methods: {
    ...
    confirmFn(e) {
      this.dong = this.pickData1.pData1[e];
    },
    chooseMonth() {
      this.show1 = true;
    },
    ...
    setImgPreview() {
      ...
      console.log(this.uploadPreviewList,666666);
    },
    update(e) {
