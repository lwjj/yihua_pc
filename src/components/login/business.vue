    ...
    <div v-show="!rentShow && !show_job">
      <el-form ref="form" class="form" :model="registerData" label-width="80px">
        <el-form-item label="" label-width="0" prop="rentName">
          <div class="font600 center" style="font-size: 18px">商家注册</div>
        </el-form-item>
        <el-form-item label="商家名称" prop="businessName">
          <el-input placeholder="请输入商家名" v-model="registerData.businessName" :maxlength="20"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    register() {
      if (this.registerData.businessName == "") {
        return this.$message.error("请输入商家名");
      ...
      var data = {
        type: 2,
        organName: this.registerData.businessName,
