    ...
    <div v-show="!rentShow && !show_job">
      <el-form ref="form" class="form" :model="registerData" label-width="80px">
        <el-form-item label="" label-width="0">
          <div class="font600 center" style="font-size: 18px">物业公司注册</div>
        </el-form-item>
        <el-form-item label="公司名称" prop="companyName">
          <el-input placeholder="请输入公司名" v-model="registerData.companyName" :maxlength="20"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    /*获取楼宇信息*/
    getLouyu() {
      this.$ajax(`${this.subUrl.user}/comm/officeBuildingList`, res => {
        if (res.data.code == 1) {
          var arr = [];
